...
const init = require('../../../../app/controllers/cart-controller');

const sinon = require('sinon');

describe('Cart controller addOfferToCart function', () => {
    ...
    describe('when an offer exist', () => {
        ...
        it('expect to return the offer',
            (done) => {
            controller.addOfferToCart(req, res)
                .then((response) => {
